...
| 🏠 Hero — Dark UI | ✨ Features Grid |
|---|---|
| ![Hero](Screenshot%202026-05-17%20125122.png) | ![Features](Screenshot%202026-05-17%20125148.png) |
| Live stats · animated badges · custom cursor | JWT · Socket.io · Groq AI · Cloudinary cards |

| ⚙️ Tech Stack | 📁 Project Structure |
|---|---|
| ![Tech Stack](Screenshot%202026-05-17%20125226.png) | ![Structure](Screenshot%202026-05-17%20125243.png) |
| 10 battle-tested technologies · grid layout | Modular MVC · 31 files · color-coded tree |

| 📡 API Endpoints | ⚡ Quick Start — Code Tabs |
|---|---|
| ![Endpoints](Screenshot%202026-05-17%20125321.png) | ![Quick Start](Screenshot%202026-05-17%20125339.png) |
| 23 endpoints · GET/POST/PUT/DELETE badges · auth | Install · Register · Socket · AI — tabbed |

| 💻 Code Examples | |
|---|---|
| ![Code](Screenshot%202026-05-17%20125407.png) | |
| Syntax highlighted · copy-paste ready · dark theme | |
